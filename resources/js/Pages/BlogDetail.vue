<template>
    <body class="font-inter">
        ...
        >
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="w-full flex items-center justify-between flex-row">
                    ...
                    <ul
                        class="hidden lg:flex items-center flex-col mt-4 lg:mt-0 lg:flex-row"
                    >
                        <li>
                            <a
                                href="javascript:;"
                                class="text-gray-100 text-sm lg:text-base mb-2 block font-medium hover:text-white transition-all duration-500 lg:mr-6 md:mb-0 lg:text-left text-center"
                                >Home</a
                            >
                        </li>
                        <li>
                        ...
                        <li class="relative">
                            <button
                                ...
                                class="flex items-center justify-between text-gray-100 text-sm text-center lg:text-base font-medium hover:text-gray-100 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left m-auto lg:m-0"
                            >
                                Products
                                <svg
                            ...
                            <div
                                id="menu1"
                                class="animate-fade z-10 absolute top-14 -left-80 bg-white rounded-lg shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] xl:p-8 lg:p-4 p-2 lg:min-w-[800px] md:min-w-[500px] min-w-full hidden"
                            >
                                <div class="flex justify-between">
                                    <ul
                                        class="text-sm text-gray-700 w-1/2"
                                        aria-labelledby="dropdownLargeButton"
                                    >
                                        <h6
                                            class="font-medium text-sm text-gray-500 mb-2"
                                        >
                                            Features
                                        </h6>
                                        <li class="">
                                    ...
                                    <ul
                                        class="text-sm text-gray-700 dark:text-gray-400 w-1/2"
                                        aria-labelledby="dropdownLargeButton"
                                    >
                                        <h6
                                            class="font-medium text-sm text-gray-500 mb-2"
                        ...
                        <li class="relative">
                            <button
                                ...
                                class="flex items-center justify-between text-gray-100 text-sm text-center lg:text-base font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 lg:mr-6 lg:mb-0 mr-auto lg:text-left m-auto lg:m-0"
                            >
                                Features
                                <svg
                                    class="w-3 h-2 ml-1.5"
                            ...
                            <div
                                id="menu2"
                                class="dropdown-menu z-10 absolute top-14 font-normal bg-white rounded-lg shadow-[0px_15px_30px_-4px_rgba(16,24,40,0.03)] w-64 xl:p-8 lg:p-4 p-2 hidden"
                            >
                                <ul
                    ...
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <button
                            class="max-[450px]:hidden bg-indigo-600 text-white rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 border border-white py-3 px-6 text-sm md:ml-5 hover:bg-indigo-700"
                        >
                            Sign up
                        </button>
                    </div>
        ...
        <section class="relative pt-20 pb-24 bg-indigo-600">
            <div
                class="w-full max-w-lg md:max-w-2xl lg:max-w-4xl px-5 lg:px-11 mx-auto max-md:px-4"
            >
                <h1
                    class="text-white font-manrope font-semibold text-4xl min-[500px]:text-5xl leading-tight mb-8"
                >
                ...
                <div class="flex items-center justify-between">
                    <div class="data">
                        <p
                            class="font-medium text-xl leading-8 text-white mb-1"
                        >
                            insights
                        </p>
        ...
        <section class="relative py-10 lg:py-16">
            ...
            >
                <p class="font-normal text-lg leading-8 text-gray-500 mb-12">
                    Certainly! A description for "Business Loans That Are Fast
                    In Services" within a UI design system might be:
                </p>

                <h4
                    class="font-manrope font-semibold text-2xl leading-9 text-black mb-12"
                >
                ...
                <p class="font-normal text-lg leading-8 text-gray-600 mb-8">
                    ...
                    design system embodies swift and efficient access to
                    financial solutions tailored for businesses. This module
                    integrates visually engaging elements and intuitive
                    functionalities to streamline the process of acquiring loans
                    with unparalleled speed. Offering a user-centric interface,
                    it presents a seamless journey for businesses seeking rapid
                    financial support. Through clear and concise layouts,
                    optimized forms, and interactive tools, this component
                    expedites the application and approval process, emphasizing
                    agility without compromising on reliability or thoroughness.
                ...
                <p class="font-normal text-lg leading-8 text-gray-600 mb-16">
                ...
                <div class="flex justify-between relative mb-16">
                    <svg
                        class="absolute top-0 left-0 w-8"
                        width="32"
                        height="30"
                        viewBox="0 0 32 30"
                        fill="none"
                    ...
                    <h4
                        class="font-manrope font-semibold text-2xl leading-9 text-black max-w-[609px] mx-auto max-lg:px-8"
                    >
                        It’s easy to get a loan unless you need it.
                    </h4>
                    <svg
                        class="absolute right-0 bottom-0 w-8"
                        width="32"
                        height="30"
                        viewBox="0 0 32 30"
                        fill="none"
                ...
                <p class="font-normal text-lg leading-8 text-gray-600 mb-12">
                ...
                <ul
                    class="list-disc list-outside flex flex-col gap-8 ml-5 mb-14"
                >
                    <li class="list-disc">
                        <p class="font-medium text-xl leading-8 text-black">
                            Types of Business Loans:
                            <span
                                class="font-normal text-base leading-7 text-black"
                            >
                                Small Business Administration (SBA) Loans:
                                Exploring government-backed options for small
                                businesses. Term Loans vs. Lines of Credit:
                                Understanding the differences and choosing the
                    ...
                    <li class="list-disc">
                        <p class="font-medium text-xl leading-8 text-black">
                            ...
                            <span
                                class="font-normal text-base leading-7 text-black"
                            >
                                Preparation: Steps to prepare your business and
                                documents before applying. Application
                                Walkthrough: A step-by-step guide through the
                                loan application process. Tips for Approval:
                                Insider tips to increase your chances of loan
                                approval.</span
                            >
                        </p>
                    </li>
                    ...
                    <li class="list-disc">
                        <p class="font-medium text-xl leading-8 text-black">
                            ...
                            <span
                                class="font-normal text-base leading-7 text-black"
                            >
                                Responsibly Managing Funds: Best practices for
                                utilizing loan funds efficiently. Repayment
                                Strategies: Formulating a repayment plan that
                                suits your business.</span
                            >
                        </p>
                    </li>
                    ...
                    <li class="list-disc">
                        <p class="font-medium text-xl leading-8 text-black">
                            ...
                            <span
                                class="font-normal text-base leading-7 text-black"
                                >Securing a business loan can be a pivotal
                                moment for your company's growth. Armed with
                                this guide, you're better equipped to navigate
                                the complexities of the loan process. Remember,
                                choosing the right loan and managing it wisely
                                can set your business on a path to
                                success.</span
                            >
                        </p>
                    </li>
                ...
                <div class="head-1 mb-12">
                    <h2
                        class="font-manrope font-semibold text-black mb-5 text-5xl leading-tight"
                    >
                        Small Business Administration (SBA) Loans:
                    </h2>
                    <p class="font-normal text-lg leading-8 text-gray-600">
                        SBA loans are government-backed loans designed to
                        support small businesses. They offer flexible terms,
                        lower down payments, and competitive rates. These loans
                        cater to various business needs, including working
                        capital, real estate purchase, or equipment financing,
                        with longer repayment periods and favorable terms.
                    </p>
                </div>

                <div class="head-2 mb-12">
                    <h3
                        class="font-manrope font-medium text-black mb-5 text-4xl"
                    >
                        Term Loans:
                    </h3>
                    <p class="font-normal text-lg leading-8 text-gray-600">
                        ...
                        purposes such as expansion, equipment purchases, or
                        covering operational costs. They typically have set
                        monthly payments and a defined repayment schedule.
                    </p>
                </div>

                <div class="head-3 mb-12">
                    <h4
                        class="font-manrope font-normal text-black mb-5 text-3xl leading-10"
                    >
                        Lines of Credit:
                    </h4>
                    <p class="font-normal text-lg leading-8 text-gray-600">
                        A business line of credit provides access to a set
                        amount of funds that can be used as needed. Similar to a
                        credit card, it offers flexibility in borrowing and
                        repaying. Interest is charged only on the amount used,
                        making it ideal for managing short-term expenses,
                        covering gaps in cash flow, or handling unexpected
                        costs.
                    </p>
                </div>
                ...
                <div class="head-4 mb-14">
                    <h5
                        class="font-manrope font-normal text-black mb-5 text-2xl leading-9"
                    >
                        Equipment Financing:
                    </h5>
                    <p class="font-normal text-lg leading-8 text-gray-600">
                        Equipment financing specifically covers the purchase or
                        lease of machinery, vehicles, or other essential
                        equipment. This loan allows businesses to acquire
                        necessary assets without tying up large amounts of
                        capital. The equipment itself serves as collateral,
                        often leading to favorable terms.
                    </p>
                </div>

                <div class="topics mb-14">
                    <h5
                        class="font-manrope font-semibold text-2xl leading-9 text-black mb-8"
                    >
                        Views on Topics
                    </h5>
                    ...
                    <ul class="list-decimal list-outside ml-5">
                        <li
                            class="font-normal text-lg leading-8 text-gray-600 pl-1"
                        >
                ...
                <div class="comments">
                    <h5
                        class="font-medium text-xl leading-8 text-gray-900 mb-8"
                    >
                        Comments
                    </h5>
                    <div
                        class="flex flex-col sm:flex-row gap-x-9 gap-y-4 w-full mb-7"
                    >
                        <img
                        ...
                        <div class="data w-full">
                            ...
                            >
                                <div class="user">
                                    <h6
                                        class="font-medium text-xl leading-8 text-black mb-1"
                                    >
                                        William Smith
                                    </h6>
                                    <p
                                        class="font-normal text-sm leading-6 text-gray-500"
                                    >
                                        Product Designer
                                    </p>
                                </div>
                                <button
                                    class="rounded-full py-3 px-6 bg-indigo-600 shadow-md font-semibold text-sm text-white"
                                >
                                    Reply
                                </button>
                            </div>
                            <p
                                class="font-normal text-base leading-7 text-gray-600"
                            >
                                I have been using pagedone for several months
                                now, and I must say that it has made my life a
                                lot easier. The platform's intuitive interface
                                and ease of use have allowed me to manage my
                                finances more effectively and make informed
                                investment decisions.
                            </p>
                        </div>
                    </div>
                    <div
                        class="flex flex-col sm:flex-row gap-x-9 gap-y-4 w-full mb-16"
                    >
                        <img
                ...
                <h5 class="font-medium text-xl leading-8 text-gray-900 mb-6">
                    Leave a comment
                </h5>
                <div
                    class="reply bg-gray-100 rounded-xl p-5 border border-solid border-gray-300 w-full"
                >
                    <div
                        class="flex items-center gap-x-9 gap-y-4 flex-col sm:flex-row mb-5"
                    >
                        <textarea
                            class="font-medium text-xl leading-8 placeholder:text-gray-500 text-gray-900 bg-transparent outline-0 w-full h-28"
                            placeholder="Type a comment here"
                        ></textarea>
                    </div>
                    <button
                        class="rounded-full py-3 px-6 bg-indigo-600 shadow-md font-semibold text-sm text-white transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-200"
                    >
                        Post
                    </button>
                </div>
        ...
        <section class="py-12 lg:py-20">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h2
                    class="font-manrope text-4xl font-bold text-gray-900 text-center mb-14"
                >
                    Our popular blogs
                </h2>
                <div
                ...
                >
                    ...
                    >
                        ...
                        <div class="block">
                            <h4
                                class="text-gray-900 font-medium leading-8 mb-9"
                            >
                                Fintech 101: Exploring the Basics of Electronic
                                Payments
                            </h4>
                            <div
                    ...
                    >
                        ...
                        <div class="block">
                            <h4
                                class="text-gray-900 font-medium leading-8 mb-9"
                            >
                                From Classroom to Cyberspace: The Growing
                                Influence of EdTech in Fintech
                            </h4>
                            <div
                                class="flex items-center justify-between font-medium"
                            >
                    ...
                    >
                        ...
                        <div class="block">
                            <h4
                                class="text-gray-900 font-medium leading-8 mb-9"
                            >
                                Fintech Solutions for Student Loans: Easing the
                                Burden of Education Debt
                            </h4>
                            <div
                                class="flex items-center justify-between font-medium"
                            >
        ...
        <footer class="w-full bg-gray-900">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <a href="javascript:;" class="flex justify-center">
                        <svg
                            class="w-40 h-8"
                            viewBox="0 0 164 33"
                            fill="none"
                    ...
                    <ul
                        class="text-lg flex flex-col sm:flex-row items-center gap-6 lg:gap-14 transition-all duration-500"
                    >
                        <li>
                            <a
                                href="javascript:;"
                ...
                <div class="py-7 border-t border-gray-700">
                    <div class="flex items-center justify-center">
                        <span class="text-gray-400"
                            >©pagedone 2024, All rights reserved.</span
                        >
                    </div>
                </div>
            </div>
