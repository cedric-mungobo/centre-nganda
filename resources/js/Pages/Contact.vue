<template>
    <body class="font-inter">
        <nav
            class="w-full py-5 transition-all duration-500 bg-slate-50 border-b border-solid border-indigo-100"
        >
            <div class="xl:px-28 lg:px-14 px-10">
                <div class="w-full flex justify-between flex-col lg:flex-row">
                    ...
                    <div class="hidden lg:flex lg:pl-11" id="navbar-default">
                        <ul
                            class="lg:flex items-center flex-col mt-4 lg:mt-0 lg:flex-row"
                        >
                            <li>
                                <a
                                    href="javascript:;"
                            ...
                            <li class="relative">
                                <button
                                    ...
                                    class="flex items-center justify-between text-gray-900 hover:text-gray-600 text-base leading-6 text-center lg:text-base font-medium hover:text-prime-blue-700 transition-all duration-500 mb-2 px-3 lg:mr-6 mr-4 lg:mb-0 lg:text-left m-auto lg:m-0"
                                >
                                    Products
                                    <svg
                                ...
                                >
                                    <div class="flex justify-between">
                                        ...
                                        >
                                            <h6
                                                class="font-medium text-gray-900 text-base leading-6 mb-2"
                                            >
                                                Features
                                            </h6>
                                            <li class="">
                        ...
                        <div
                            class="flex items-center justify-center xl:ml-14 ml-2 gap-x-5"
                        >
                            <button
                                class="w-20 h-11 text-white text-sm font-semibold leading-5 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 rounded-full"
                            >
                                Login
                            </button>
                            <button
                                class="w-24 h-11 rounded-full bg-gray-900 hover:bg-gray-700 transition-all duration-700 shadow-sm text-white text-sm font-semibold leading-5"
                            >
                                Sign up
                            </button>
                        </div>
                    ...
                    >
                        <div>
                            ...
                            >
                                ...
                                questions, feedback, or inquiries, our team is
                                ready to help.
                            </p>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        We Provide Various Methods For You To
                                        Carry Out All Transactions Related To
                                        Your Finances
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    <p
                                        class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white"
                                    >
                                        We have the most up-to-date security to
                                        support the security of all our
                                        customers in carrying out all
                                        transactions.
                                    </p>
                                </div>
                            </div>
                            <div
                                class="border-t border-slate-200 pt-12 flex lg:justify-start justify-center"
                            >
                                <div
                                    class="flex gap-x-1 border-r border-indigo-300 items-center"
                                >
                                    <svg
                                        width="24"
                                        height="24"
                                    ...
                                    >
                                        <g clip-path="url(#clip0_9225_63160)">
                                            ...
                                            />
                                            <g
                                                clip-path="url(#clip1_9225_63160)"
                                            >
                                                <path
                                                    d="M10.9239 2.78195C11.3641 1.89005 12.6359 1.89005 13.0761 2.78195L15.2475 7.18173C15.4223 7.5359 15.7602 7.78139 16.151 7.83818L21.0065 8.54372C21.9907 8.68674 22.3838 9.89631 21.6715 10.5905L18.1581 14.0153C17.8753 14.291 17.7462 14.6882 17.813 15.0775L18.6424 19.9133C18.8105 20.8936 17.7816 21.6411 16.9013 21.1783L12.5584 18.8951C12.2088 18.7113 11.7912 18.7113 11.4416 18.8951L7.09875 21.1783C6.21839 21.6411 5.18947 20.8936 5.3576 19.9133L6.18701 15.0775C6.25378 14.6882 6.12472 14.291 5.8419 14.0153L2.32846 10.5906C1.61624 9.89631 2.00925 8.68674 2.99352 8.54372L7.84897 7.83818C8.23982 7.78139 8.5777 7.5359 8.75249 7.18173L10.9239 2.78195Z"
                                                    fill="#F59E0B"
                        ...
                        >
                            ...
                            <button
                                class="w-full h-12 rounded-full bg-indigo-600 hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center"
                            >
                                Send message
                                <svg
                                    width="20"
            ...
            <section class="w-full xl:py-28 lg:py-20 py-12">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="lg:mb-16 mb-10">
                        <h6
                            class="text-lg text-indigo-600 font-medium text-center mb-2 leading-7"
                        >
                            FAQs
                        </h6>
                        <h2
                            class="lg:text-4xl text-3xl font-manrope text-center font-bold text-gray-900 leading-tight"
                        >
                            Frequently asked questions
                        </h2>
                    </div>
                    <div
                        class="accordion-group w-full max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                <p
                                    class="text-base text-gray-600 font-normal leading-6"
                                >
                                    To reset your password, go to the login page
                                    and click on the "Forgot password" link.
                                    Enter the email address associated with your
                                    account, and you will receive an email with
        ...
        <footer class="w-full bg-gray-900">
            <div class="w-full max-w-7xl px-5 lg:px-8 mx-auto">
                <!--Grid-->
                <div
                    class="grid grid-cols-2 min-[810px]:grid-cols-4 lg:gap-8 gap-3 pt-14 pb-20 max-w-lg mx-auto min-[810px]:max-w-full"
                >
                    <div class="block">
                        <h4 class="text-xl text-white font-bold mb-7">
                            Pagedone
                        </h4>
