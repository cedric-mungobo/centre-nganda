<template>
    ...
    <section class="mb-4">
        <div class="border border-border-light dark:border-border-dark rounded-2xl  p-2 md:p-8">
                ...
                <div class=" grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-gray-50 rounded-xl p-6 border-l-4 border-pink-400">
                        ...
                        <p class="text-gray-700 ml-6">
                            Dépistage des hépatites B/C par prise de sang.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 border-l-4 border-pink-400">
                        ...
                        <p class="text-gray-700 ml-6">
                            Idem + dépistage du cancer du col + dépistage du cancer du sein (par examen clinique et échographie).
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 border-l-4 border-pink-400">
                        ...
                        <p class="text-gray-700 ml-6">
                            Mammographie + dépistage du cancer colorectal (par recherche de sang occulte).
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6 border-l-4 border-pink-400">
                        ...
                        <p class="text-gray-700 ml-6">
                            Dépistage des hépatites B/C + dépistage du cancer colorectal.
                        </p>
                    </div>
                </div>
            </div>
