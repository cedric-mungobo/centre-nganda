    ...
    <main id="content" class="site-content" role="main">
      <section id="panels">
        <div id="panels-container" style="width: 310%">
          <section class="h-screen w-full flex bg-secondary panel full-screen">
          ...
          >
            <div class="md:pt-52 md:px-10 pl-3 text-white">
              ...
              <div class="" v-animate="'backInUp'">
                <p class="text-gray-200">
                  Le Centre Hospitalier Nganda est un établissement médical
                  privé de Kinshasa, en République Démocratique du Congo,
                  reconnu pour son expertise dans le diagnostic et le traitement
                  du cancer. Depuis plus de 30 ans, nous mettons tout en œuvre
                  pour offrir à nos patients une prise en charge médicale de
                ...
                <div class="w-full px-6 lg:px-8" v-animate="'slideInRight'">
                  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div class="text-center">
                      ...
                      >
                        Prenez soin de votre santé dans le confort de votre
                        foyer
                      </h1>
                      <p class="mt-6 text-sm text-start text-gray-300">
                        Nganda Home Care est un service de soins de santé à
                        domicile qui offre une prise en charge médicale et
                        paramédicale de qualité aux patients de tous âges. Notre
                        équipe d'infirmiers, d'aides-soignants et de
                        professionnels de santé qualifiés est à votre
                        disposition pour vous prodiguer les soins dont vous avez
                        besoin, dans le confort et la sécurité de votre
                        domicile.
                      </p>
                      <div
