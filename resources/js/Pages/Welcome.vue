...
const services1 = [
  {
    title: "Oncologie",
    description:
      " Nous sélectionnons soigneusement nos équipes. Nos experts en oncologie utilisent les dernières avancées pour offrir dessoins personnalisés et de haute qualité aux patients atteints de cancer.",
  },
  {
    title: "Soins contre le cancer",
    description:
      "Le service de soins contre le cancer offre des traitements innovants et un soutien émotionnel complet pour accompagner les patients et leurs familles tout au long du processus de guérison.",
  },
  {
    title: " Cas d'urgence",
    description:
      " Le service des urgences, disponible 24/7, assure une prise en charge rapide et efficace des situations critiques grâce à une équipe qualifiée et des infrastructures modernes.",
  },
  //   {
  //     title: "Pédiatrie",
  //     description:
  //       "  Notre service de pédiatrie offre des soins complets et bienveillants aux enfants, de la naissance à l'adolescence. Nos pédiatres expérimentés assurent le suivi de la croissance et du développement, ainsi que le traitement des maladies infantiles courantes et complexes.",
  //   },
];
</script>
...
<template>
  ...
  <GuestLayout>
      ...
      <div class="md:pt-52 md:px-10 pl-3 text-white">
        ...
        <div class="" v-animate="'backInUp'">
          <p class="text-gray-200">
            L'équipe du Centre Hospitalier Nganda s'engage à vous offrir les
            meilleurs soins de santé à Kinshasa.
          </p>
          <div class="py-6">
            <button
              type="button"
    ...
    <section
      v-animate="'zoomIn'"
      class="ezy__service13 light py-5 md:py-24 bg-white text-zinc-900"
    >
      <div class="container px-4 mx-auto">
        <div class="flex items-center justify-center mb-6 sm:mb-5">
          <div class="w-full max-w-xl text-center">
            <h2 class="text-3xl leading-none md:text-[45px] font-bold mb-4">
              Nos services
            </h2>
            <p class="text-lg opacity-80 mb-6">
              Nous accordons la plus haute importance à fournir des soins et des
              services médicaux de haute qualité à nos patients
            </p>
          </div>
        </div>
        <div class="grid grid-cols-3 gap-6 lg:gap-12 pt-2">
          <div class="col-span-3 lg:col-span-1 lg:order-2">
            <div
              class="bg-center bg-no-repeat bg-cover rounded-2xl h-full min-h-[200px]"
              style="background-image: url(/assets/images/BRU_9885.jpg)"
            ></div>
          </div>
          <div class="col-span-3 lg:col-span-1 ezy__service13-list">
            <div class="lg:my-5">
              <div
                class="flex mt-12 lg:text-end"
                v-for="item in services1"
                :key="item.title"
              >
                <div class="mr-4 lg:mr-0 lg:ml-4 lg:order-2">
                  <span
                    class="bg-red-500 text-white w-16 h-16 rounded-full text-3xl inline-flex justify-center items-center mb-6"
          ...
          <div class="col-span-3 lg:col-span-1 ezy__service13-list lg:order-3">
            <div class="lg:my-5">
              <div
                class="flex mt-12 lg:text-end"
                v-for="item in services1"
      ...
      >
        <div class="flex flex-col items-center justify-between lg:flex-row">
          <div class="lg:max-w-lg lg:pr-5">
            <div class="max-w-screen-xl py-16" v-animate="'backInLeft'">
              <h2
              ...
              <p class="text-base text-gray-700">
                Nous offrons des soins primaires quand vous en avez besoin.
                Recevez des soins personnalisés et de haute qualité en
                consultant les meilleurs médecins.
              </p>
          ...
          >
            <div class="border-b-8 border-b-blue-600 max-w-lg mx-auto mb-1">
              <img
          ...
          <div class="w-full px-6 lg:px-8" v-animate="'slideInRight'">
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="text-center">
                ...
                >
                  Prenez soin de votre santé dans le confort de votre foyer
                </h1>
                <p class="mt-6 text-sm text-start text-gray-300">
                  Nganda Home Care est un service de soins de santé à domicile
                  qui offre une prise en charge médicale et paramédicale de
                  qualité aux patients de tous âges. Notre équipe d'infirmiers,
                  d'aides-soignants et de professionnels de santé qualifiés est
                  à votre disposition pour vous prodiguer les soins dont vous
                  avez besoin, dans le confort et la sécurité de votre domicile.
                </p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <a href="#" class="text-sm font-semibold leading-6 text-white"
                    >Savoir plus <span aria-hidden="true">→</span></a
                  >
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <p class="text-lg text-white">
                  Découvrez le meilleur centre de radiothérapie de Kinshasa au
                  Centre Hospitalier Nganda. Avec notre technologie de pointe et
                  notre équipe dévouée, nous vous offrons des soins
                  exceptionnels pour votre bien-être et votre santé. Faites-nous
                  confiance pour un traitement efficace et personnalisé, où
                  chaque étape est pensée pour vous assurer confort et guérison
                  optimale.
                </p>
                <a
    ...
    <section>
      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
          ...
          >
            <div
              class="sm:w-[564px] w-full sm:h-[646px] h-full sm:bg-primary rounded-3xl sm:border border-secondary relative"
            >
              <img
          ...
          <div class="mt-5 sm:mt-10 lg:mt-0" v-animate="'backInRight'">
            <div class="space-y-6 sm:space-y-8">
              ...
              <div class="space-y-2 md:space-y-4">
                ...
                <p class="text-gray-500 dark:text-neutral-500">
                  Nos médecins sont parmi les meilleurs disponibles dans la
                  ville. Pour des soins d'urgence, des consultations avec des
                  experts, et des services dans un centre moderne, nous sommes à
                  votre disposition 24 heures sur 24, 7 jours sur 7.
                </p>
              </div>
              <!-- End Title -->
              ...
              <ul class="space-y-2 sm:space-y-4">
                <li class="flex space-x-3">
                  ...
                  <span
                    class="text-sm sm:text-base text-gray-500 font-semibold"
                  >
                    Cas d'Urgence
                  </span>
                </li>
          ...
          <div class="mb-16 text-center lg:mb-0 lg:max-w-lg lg:text-left">
            <div class="mb-6 max-w-xl">
              <div>
                ...
                >
                  Nganda Home Care Service de Soins à Domicile à Kinshasa
                </p>
              </div>
              <h2
              ...
              >
                ...
                <span class="inline-block text-blue-500">de leur foyer</span>
              </h2>
              <p class="text-base text-gray-700 md:text-lg">
                Vous cherchez un service de soins à domicile fiable et
                professionnel à Kinshasa ? Ne cherchez pas plus loin que NGANDA
                HOME CARE. Nous offrons une large gamme de services de soins à
                domicile pour répondre aux besoins de vos proches, leur
                permettant ainsi de vivre en toute sécurité et confortablement
    ...
    <section v-animate="'zoomIn'">
      ...
      <!-- Card Blog -->
      <div class="max-w-screen-xl px-3 py-10 sm:px-6 lg:px-0 lg:py-14 mx-auto">
        <!-- Title -->
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              <h3 class="text-xl text-white group-hover:text-white">
                <span class="font-bold">Prendre Rendez-vous en Ligne</span>
                <br />
                <br />
                Pour vous faciliter la vie, le Centre Hospitalier Nganda vous
                propose de prendre rendez-vous en ligne.
