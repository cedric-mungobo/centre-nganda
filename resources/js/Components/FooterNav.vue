            ...
            >
                ...
                >
                    <div class="mb-2 lg:mb-0">
                        ...
                        >
                            <span class="sr-only">Centre nganda</span>
                            <ApplicationLogo
                                class="block h-10 sm:h-12 w-auto fill-current"
                            />
                        </Link>
                        <p
                            class="md:py-6 mt-3 text-sm text-gray-600 lg:max-w-xs text-center lg:text-left leading-relaxed"
                        >
                    ...
                    <div class="lg:mx-auto">
                        <h4 class="text-lg text-gray-900 font-semibold mb-7 border-b border-gray-200 pb-2">
                            Liens
                        </h4>
                        ...
                        <ul class="text-sm transition-all duration-500">
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <span class="text-gray-600">
                                    Lundi - Vendredi: <span class="font-medium">8h00 - 18h00</span>
                                </span>
                            </li>
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <span class="text-gray-600">
                                    Samedi: <span class="font-medium">8h00 - 14h00</span>
                                </span>
                            </li>
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <span class="text-gray-600">
                                    Dimanche: <span class="font-medium">Fermé</span>
                                </span>
                            </li>
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <a
                    ...
                    <div class="lg:mx-auto">
                        ...
                        <ul class="text-sm transition-all duration-500">
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <a
                                    href="tel:+243897000133"
                                    class="text-gray-600 hover:text-blue-dark flex items-center"
                                    ><span class="mr-2">→</span>Réception: +243 897 000 133</a
                                >
                            </li>
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <a
                                    ...
                                    class="text-gray-600 hover:text-blue-dark flex items-center"
                                    ><span class="mr-2">→</span>Homecare: +243 897 000 130</a
                                >
                            </li>
                            <li class="mb-4 hover:translate-x-1 transition-transform">
                                <a
                ...
                <div class="py-7 border-t border-gray-200">
                    ...
                    >
                        ...
                        >
                            <a
                                href="javascript:;"
                                class="w-10 h-10 rounded-full bg-gray-700 flex justify-center items-center hover:bg-blue-dark transform hover:scale-110 transition-all duration-300"
                            >
                                <svg
