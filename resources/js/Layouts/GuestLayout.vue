...
<template>
  <div class="min-h-screen overflow-y-auto bg-white">
      ...
      >
        ...
        >
          ...
          <div class="hidden items-center justify-end lg:flex lg:flex-1 lg:w-0">
            <a
              href="#"
              class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-custom bg-secondary px-6 py-1.5 text-base font-medium text-white shadow-sm hover:bg-secondary"
            ...
            >
              ...
              <div class="px-5 py-6">
                <div class="mt-6">
                  <a
                    href="#"
                    class="flex w-full items-center justify-center rounded-md border border-transparent bg-secondary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-secondary"
                    >Prenez rendez-vous</a
                  >
                </div>
              </div>
    ...
    >
      <main v-if="$slots.default" class="w-full">
        <slot></slot>
      </main>
    </transition> -->
    <main class="w-full">
    ...
    <footer v-animate="'backInUp'" class="w-full px-3 lg:px-0">
      <div class="mx-auto max-w-screen-xl bg-primary px-3 mb-5 rounded-custom">
        <!--Grid-->
        <div
          class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 py-10 max-md:max-w-md max-md:mx-auto"
        >
          <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            ...
            >
              <span class="sr-only">Your Company</span>
              <ApplicationLogo class="block h-8 sm:h-10 w-auto fill-current" />
            </Link>
            <p
              class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left"
            >
              Le Centre Hospitalier Nganda est le premier centre médical privé à
              introduire le scanner en RDC et aujourd’hui, il est encore le
              premier et unique centre à offrir la radiothérapie dans son panel
              de soins en RDC.
            </p>
          </div>
          <!--End Col-->
          ...
          <div class="lg:mx-auto">
            <h4 class="text-lg text-gray-900 font-medium mb-7">Liens</h4>
          ...
          <div class="lg:mx-auto">
            ...
            <ul class="text-sm transition-all duration-500">
              ...
              <li class="mb-6">
                <a
                  href="javascript:;"
                  class="text-gray-600 hover:text-gray-900 whitespace-wrap"
                  >reception@centrehospitaliernganda.com</a
                >
              </li>
              <li class="mb-6">
                <a href="javascript:;" class="text-gray-600 hover:text-gray-900"
                  >N°3816 , av haute Tension/Nganda C/Kintambo Kinshasa</a
                >
              </li>
            </ul>
          </div>
        ...
        <div class="py-7 border-t border-gray-200">
          ...
          >
            <span class="text-sm text-gray-500 lg:mb-0 mb-4"
              >©Centre Hospitalier Nganda 2024, All rights reserved.</span
            >
