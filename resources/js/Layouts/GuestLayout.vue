    ...
    >
      <main v-if="$slots.default" class="w-full">
        ...
        <footer class="w-full px-3 lg:px-0">
            <div
                class="mx-auto max-w-screen-2xl bg-zinc-100 px-3 mb-5 rounded-custom"
            >
                <!--Grid-->
                <div
                ...
                >
                    <div class="mb-2 lg:mb-0">
                        ...
                        >
                            ...
                            <ApplicationLogo
                                class="block h-8 sm:h-10 w-auto fill-current"
                            />
                        </Link>
                        <p
                            class="md:py-8 mt-2 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left"
                        >
                            Le Centre Hospitalier Nganda est le premier centre
                            médical privé à introduire le scanner en RDC et
                            aujourd’hui, il est encore le premier et unique
                            centre à offrir la radiothérapie dans son panel de
                            soins en RDC.
                        </p>
                    </div>
                    <!--End Col-->
                    ...
                    <div class="lg:mx-auto">
                        ...
                        <ul class="text-sm transition-all duration-500">
                            ...
                            <li class="mb-6">
                                <a
                                    href="javascript:;"
                                    class="text-gray-600 hover:text-gray-900 text"
                            ...
                            <li class="mb-6">
                                <a
                                    href="javascript:;"
                                    class="text-gray-600 hover:text-gray-900"
                                    >N°3816 , av haute Tension/Nganda C/Kintambo
                                    Kinshasa</a
                                >
                            </li>
                        </ul>
                ...
                <div class="py-7 border-t border-gray-200">
                    ...
                    >
                        <span class="text-sm text-gray-500 lg:mb-0 mb-4"
                            >©Centre Hospitalier Nganda 2024, All rights
                            reserved.</span
                        >
                        <div
